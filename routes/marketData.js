...
const admin = require('../firebaseAdmin'); // Firebase Admin for notifications
...
router.put('/:id', async (req, res) => {
  try {
    ...
    if (aankdo_open || aankdo_close) {
      const notificationTitle = `${updatedMarket.market_name} Market Update`;
      const notificationBody = `Aankdo Open: ${aankdo_open || updatedMarket.aankdo_open}, Aankdo Close: ${aankdo_close || updatedMarket.aankdo_close}`;
